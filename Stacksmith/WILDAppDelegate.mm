...
-(void)	initializeParser
{
	...
	struct TStringConstantEntry	visualEffectNames[] = {
		...
		{ { ECheckMarkIdentifier, ELastIdentifier_Sentinel, ELastIdentifier_Sentinel }, EMenuItemMarkCharChecked },
		{ { EMixedMarkIdentifier, ELastIdentifier_Sentinel, ELastIdentifier_Sentinel }, EMenuItemMarkCharMixed },
